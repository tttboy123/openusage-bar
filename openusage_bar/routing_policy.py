...
from .routing_contract import EXECUTION_CLASSES, MAX_COUNTER, TARGET_PRIVACY_CLASSES
...
class RoutePolicy:
    ...
    def __post_init__(self) -> None:
        ...
        if self.revision == 0 or self.latency_reference_ms == 0 or self.cost_reference_micros == 0:
