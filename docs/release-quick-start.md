...
OpenUsage Bar 0.7.0 支持 Apple Silicon Mac 和 macOS 15 或更高版本。

## 图形化安装（推荐）

1. 从 [v0.7.0 发布页](https://github.com/tttboy123/openusage-bar/releases/tag/v0.7.0)
   下载 `OpenUsage-Bar-v0.7.0-macos-arm64.dmg`。
...
Download the v0.7.0 DMG, open it, drag **OpenUsage Bar** to **Applications**,
...
```bash
shasum -a 256 -c OpenUsage-Bar-v0.7.0-macos-arm64.dmg.sha256
```
